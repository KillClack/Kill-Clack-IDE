		...
		>
			...
			>
				...
				<div className="text-sm text-void-fg-3 mb-4">
					{type === 'default' ? `${modelName} comes packaged with Killclack, so you shouldn't need to change these settings.`
						: isUnrecognizedModel
							? `Model not recognized by Killclack.`
							: `Killclack recognizes ${modelName} ("${recognizedModelName}").`}
				</div>
...
export const OllamaSetupInstructions = ({ sayWeAutoDetect }: { sayWeAutoDetect?: boolean }) => {
	return <div className='prose-p:my-0 prose-ol:list-decimal prose-p:py-0 prose-ol:my-0 prose-ol:py-0 prose-span:my-0 prose-span:py-0 text-void-fg-3 text-sm list-decimal select-text'>
		...
		{sayWeAutoDetect && <div className=' pl-6'><ChatMarkdownRender string={`Killclack automatically detects locally running models and enables them.`} chatMessageLocation={undefined} /></div>}
	</div>
}
        ...
        `}
				...
				<main className="flex-1 p-6 select-none">
					...
					<div className='max-w-3xl'>
						...
						<h1 className='text-2xl w-full'>{`Killclack's Settings`}</h1>
						...
						<div className='flex flex-col gap-12'>
							...
							<div className={shouldShowTab('localProviders') ? `` : 'hidden'}>
								<ErrorBoundary>
									...
									<h3 className={`text-void-fg-3 mb-2`}>{`Killclack can access any model that you host locally. We automatically detect your local models by default.`}</h3>
							...
							<div className={shouldShowTab('providers') ? `` : 'hidden'}>
								<ErrorBoundary>
									...
									<h3 className={`text-void-fg-3 mb-2`}>{`Killclack can access models from Anthropic, OpenAI, OpenRouter, and more.`}</h3>
								...
								<ErrorBoundary>
									...
									<div className='flex flex-col gap-y-8 my-4'>
										...
										<div className='w-full'>
											...
											<div className='text-sm text-void-fg-3 mt-1'>{`Settings that control the visibility of Killclack suggestions in the code editor.`}</div>
							...
							<div className={`${shouldShowTab('general') ? `` : 'hidden'} flex flex-col gap-12`}>
								...
								<div>
									<ErrorBoundary>
										...
										<h4 className='text-void-fg-3 mb-4'>{`Transfer your editor settings into Killclack.`}</h4>
								...
								<div>
									...
									<h4 className='text-void-fg-3 mb-4'>{`Transfer Killclack's settings and chats in and out of Killclack.`}</h4>
								...
								<div className='max-w-[600px]'>
									...
									<h4 className={`text-void-fg-3 mb-4`}>Very basic anonymous usage tracking helps us keep Killclack running smoothly. You may opt out below. Regardless of this setting, Killclack never sees your code, messages, or API keys.</h4>
								...
								<ErrorBoundary>
									...
									<h4 className={`text-void-fg-3 mb-4`}>Configure Daily and Deepgram for voice-based interactions with AI.</h4>

									<div className='flex flex-col gap-4 max-w-xl'>
									{/* Daily API Key */}
									<div>
										<label className='text-sm text-void-fg-3 mb-1 block'>
										Daily API Key <span className='text-red-500'>*</span>
										</label>
										<VoidSimpleInputBox
										value={settingsState.globalSettings.dailyApiKey}
										...
										The API key for your Daily.co account (required)
										</div>
									</div>
									...
									<div>
										...
										placeholder="Enter your Daily Room Domain (e.g. 'mycompany.daily.co')"
										compact={true}

										/>
										<div className='text-xs text-void-fg-4 mt-1'>
										Meeting room domain for Daily.
										</div>
									</div>
									...
									<div>
										...
										<VoidSimpleInputBox
										value={settingsState.globalSettings.deepgramApiKey}
										...
										/>
										<div className='text-xs text-void-fg-4 mt-1'>
										Your Deepgram API key for speech-to-text transcription (required).
										</div>
									</div>
									</div>
								</ErrorBoundary>
...
Alternatively, place a \`.killclackrules\` file in the root of your workspace.
								`} chatMessageLocation={undefined} />
									</h4>
									<ErrorBoundary>
										<AIInstructionsBox />
									...
									<div className='my-4'>
										...
										<div className='text-void-fg-3 text-xs mt-1'>
											{`When disabled, Killclack will not include anything in the system message except for content you specified above.`}
										</div>
									</div>
								</div>
