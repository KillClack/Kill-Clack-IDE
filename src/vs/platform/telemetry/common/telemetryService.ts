...
Killclack separately records basic usage like the number of messages people are sending. If you'd like to disable Killclack metrics, you may do so in Killclack's Settings.
`;
